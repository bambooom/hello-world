use crate::status::{ParseStatusError, Status}; // need to like import ParseStatusError
...
pub enum TicketNewError {
    ...
    DescriptionTooLong,
    #[error("{0}")] // 0 is the first parameter of the error, in this case ParseStatusError
    InvalidStatus(#[from] ParseStatusError), // from source
}
